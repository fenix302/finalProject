...
-- 구매내역 초기 데이터
Insert into STAR_CAFE.TB_SELL (SELL_CODE,PRODUCT_CODE,USER_CODE,SELL_PRICE,SELL_COUNT,SELL_YN,SELL_DATE) 
values ('S0001','C001','3',25000,1,'Y','2023-03-28 17:42');
Insert into STAR_CAFE.TB_SELL (SELL_CODE,PRODUCT_CODE,USER_CODE,SELL_PRICE,SELL_COUNT,SELL_YN,SELL_DATE) 
values ('S0002','C003','3',25000,1,'Y','2023-03-28 17:42');
Insert into STAR_CAFE.TB_SELL (SELL_CODE,PRODUCT_CODE,USER_CODE,SELL_PRICE,SELL_COUNT,SELL_YN,SELL_DATE) 
values ('S0003','G0010','3',5900,1,'Y','2023-03-28 17:42');
Insert into STAR_CAFE.TB_SELL (SELL_CODE,PRODUCT_CODE,USER_CODE,SELL_PRICE,SELL_COUNT,SELL_YN,SELL_DATE) 
values ('S0004','G0014','3',8000,1,'Y','2023-03-28 17:42');
Insert into STAR_CAFE.TB_SELL (SELL_CODE,PRODUCT_CODE,USER_CODE,SELL_PRICE,SELL_COUNT,SELL_YN,SELL_DATE) 
values ('S0005','G0016','3',12000,1,'Y','2023-03-28 17:42');
Insert into STAR_CAFE.TB_SELL (SELL_CODE,PRODUCT_CODE,USER_CODE,SELL_PRICE,SELL_COUNT,SELL_YN,SELL_DATE) 
values ('S0006','R0020','3',44640,1,'Y','2023-03-28 17:42');
...
-- 장바구니 초기 데이터
Insert into STAR_CAFE.TB_CART (CART_CODE,PRODUCT_CODE,USER_CODE,CART_PRICE,CART_COUNT,CART_DATE) values ('C0002','C002','3',75000,3,'2023-03-28 17:36');
Insert into STAR_CAFE.TB_CART (CART_CODE,PRODUCT_CODE,USER_CODE,CART_PRICE,CART_COUNT,CART_DATE) values ('C0003','C003','3',25000,1,'2023-03-28 17:40');
Insert into STAR_CAFE.TB_CART (CART_CODE,PRODUCT_CODE,USER_CODE,CART_PRICE,CART_COUNT,CART_DATE) values ('C0004','P0019','3',18000,1,'2023-03-28 17:40');
Insert into STAR_CAFE.TB_CART (CART_CODE,PRODUCT_CODE,USER_CODE,CART_PRICE,CART_COUNT,CART_DATE) values ('C0005','P0017','3',35000,1,'2023-03-28 17:40');
Insert into STAR_CAFE.TB_CART (CART_CODE,PRODUCT_CODE,USER_CODE,CART_PRICE,CART_COUNT,CART_DATE) values ('C0006','C001','3',25000,1,'2023-03-28 17:40');
...
-- 상품 후기 댓글 초기 데이터
Insert into STAR_CAFE.TB_REPLY (PRODUCT_CODE,USER_CODE,USER_REPLY_NO,USER_REPLY,REPLY_DATE) values ('C001','3',1,'맛있어요!!','2023-03-28 17:47');
Insert into STAR_CAFE.TB_REPLY (PRODUCT_CODE,USER_CODE,USER_REPLY_NO,USER_REPLY,REPLY_DATE) values ('C003','3',1,'맛있어서 자주 시켜먹어요','2023-03-28 17:48');
Insert into STAR_CAFE.TB_REPLY (PRODUCT_CODE,USER_CODE,USER_REPLY_NO,USER_REPLY,REPLY_DATE) values ('R0020','3',1,'날짜에 맞춰서 잘 배송됩니다~','2023-03-28 17:48');
Insert into STAR_CAFE.TB_REPLY (PRODUCT_CODE,USER_CODE,USER_REPLY_NO,USER_REPLY,REPLY_DATE) values ('G0014','3',1,'이뻐요~','2023-03-28 17:48');
Insert into STAR_CAFE.TB_REPLY (PRODUCT_CODE,USER_CODE,USER_REPLY_NO,USER_REPLY,REPLY_DATE) values ('G0016','3',1,'좋아요!','2023-03-28 17:48');
Insert into STAR_CAFE.TB_REPLY (PRODUCT_CODE,USER_CODE,USER_REPLY_NO,USER_REPLY,REPLY_DATE) values ('G0010','3',1,'선물용으로 딱이에요~','2023-03-28 17:49');
...
INSERT INTO TB_NOTICE(BNO, TITLE, CONTENT, WRITER, REGDATE) VALUES (5, '홈페이지 이용약관 / 카페 천성 카드 이용약관 개정 안내[정정 안내]', '안녕하세요. 카페 천성 홈페이지 이용약관과 카페 천성 카드 이용약관이 개정되어 변경내용을 안내 드립니다.'
||CHR(10)||CHR(13)||
'감사합니다.', '관리자', sysdate);
...
-- 자유게시판 데이터
INSERT INTO TB_FREE(BNO, TITLE, CONTENT, WRITER, REGDATE) VALUES (1, '자유게시판입니다.', '안녕하세요 카페 천성입니다. 이 곳은 자유게시판입니다.', '관리자', SYSDATE);
...
-- 문의게시판 초기 데이터
INSERT INTO TB_INQUIRY(BNO, TITLE, CONTENT, WRITER, REGDATE) VALUES (1, '문의게시판입니다.', '안녕하세요 카페 천성입니다. 이 곳은 문의게시판입니다.', '관리자', SYSDATE);
INSERT INTO TB_INQUIRY(BNO, TITLE, CONTENT, WRITER, REGDATE) VALUES (2, '배송은 얼마나 걸리나요?', '안녕하세요 어제 구매했는데 배송은 언제쯤 되나요?', 'ksy', SYSDATE);
