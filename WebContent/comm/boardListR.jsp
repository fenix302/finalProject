...
<div class="container" style="margin-top: 140px; margin-bottom: 140px;">
						...
						<table width="100%"
							...
							<tbody>
		                    	<c:forEach items="${dsBoardList}" var="dsBoardList" varStatus="courseIdx">
		                         <tr>
		  							<td class="td_1"><a class="nt" href ="${context}/work/comm/retrieveBoard.do?bno=${dsBoardList.bno}" >${dsBoardList.bno}</a></td>
									<td class="td_2"><a class="nt" href="${context}/work/comm/retrieveBoard.do?bno=${dsBoardList.bno}" >${dsBoardList.title}</a></td>
		...
		<!-- 			table 태그의 끝 	-->
						...
						<div class="row">
							<div class="col-lg-12">
								<form id="searchForm" action="/work/comm/retrieveBoardList.do" method="get">
