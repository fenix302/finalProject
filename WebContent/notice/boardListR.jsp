					...
					<div class="panel-heading">
						<c:if
							...
							<button id="regBtn" type="button"
								class="btn btn-xs regBtn write_btn">새 글 쓰기</button>
						</c:if>
					</div>						
						...
						<table width="100%"
							...
							<tbody>
								<c:forEach items="${dsBoardList}" var="dsBoardList"
									varStatus="courseIdx">
									<tr>
										<td class="td_1"><a class="move" href="${dsBoardList.bno}">${dsBoardList.bno}</a></td>
										<td class="td_2"><a class="move" href="${dsBoardList.bno}">${dsBoardList.title}</a></td>
...
<!-- --------------------------------------------------------------------- -->
						...
						<div class="row">
							<div class="col-lg-12">
								<form id="searchForm" action="/work/notice/retrieveBoardList.do"
									method="get">
...
<!-- --------------------------------------------------------------------- -->	
	...
	<form id="actionForm" action="/work/notice/retrieveBoardList.do"
		method="get">
