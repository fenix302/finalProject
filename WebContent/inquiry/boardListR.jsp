...
<div class="container" style="margin-top: 2%; margin-bottom: 10%;">
						...
						<table width="100%"
							...
							<tbody>
		                    	<c:forEach items="${dsBoardList}" var="dsBoardList" varStatus="courseIdx">
		                         <tr>
		  							<td><a class="nt" href ="${context}/work/inquiry/retrieveBoard.do?bno=${dsBoardList.bno}" >${dsBoardList.bno}</a></td>
									<td><a class="nt" href="${context}/work/inquiry/retrieveBoard.do?bno=${dsBoardList.bno}" >${dsBoardList.title}</a></td>
		...
		<!-- 			table 태그의 끝 	-->
						...
						<div class="row">
							<div class="col-lg-12">
								<form id="searchForm" action="/work/inquiry/retrieveBoardList.do" method="get">
	...
	<!-- 			tables.html 소스에서 가져오고, 컨트롤 + 쉬프트 + F 로 정렬 처리		 -->
		...
		<form id="actionForm" action="/work/inquiry/retrieveBoardList.do" method="get">
			...
			$(document).ready(
					function() {
						...
						$(".move").on("click", function (e) {
							...
							actionForm.attr("action","/work/inquiry/retrieveBoard.do");
							actionForm.submit();
						});
